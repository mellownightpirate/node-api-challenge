...
Express gives routing and middleware support.

- [x] Describe Middleware?

Middleware is a middle layer function which can assess the http request and provide a response.

- [x] Describe a Resource?

A resource is a static file such as images, CSS files and JavaScript files. 

- [x] What can the API return to help clients know if a request was successful?

Success codes and json to return a message with the request.

- [x] How can we partition our application into sub-applications?

Using require we can import sub-apps of the api.
